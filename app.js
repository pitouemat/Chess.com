...
const TILE_SIZE = 50;
const WHITE_TILE_COLOR = "rgb(118, 150, 86)";
const BLACK_TILE_COLOR = "#EEEED2";
const HIGHLIGHT_COLOR = "rgb(200, 175, 75, 002)";
const WHITE = 0;
const BLACK = 1;
...
function changeCurrentTeam() {
    if (currentTeam === WHITE) {
        currentTeamText.textContent = "Pretas Jogam";
        currentTeam = BLACK;
    } else {
        currentTeamText.textContent = "Brancas Jogam";
        currentTeam = WHITE;
    }
}
